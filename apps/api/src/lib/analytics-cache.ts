 ...
 * edge TTL is its remaining lifetime, never a fresh extra hour. Cold requests
 * can duplicate work, but request-scoped promises and Responses are never
 * shared through module state across Worker requests. */
