  ...
  return (
    <div className="p-3">
      ...
      <div className="space-y-2">
        ...
        <div>
          ...
          <div className="text-xs text-zinc-400">
            {info?.first_issuance_block_time
              ? <>{formatDate(info.first_issuance_block_time)} <span className="text-zinc-500">({formatTimeAgo(info.first_issuance_block_time)})</span></>
              : '—'}
          </div>
        </div>
        <div>
        ...
        {info?.asset_longname && (
          <div>
            <div className="text-xs text-zinc-500">Subasset of</div>
