...
const holders = [
  { address: '1Pe7...k8Fd', balance: '125,000,000', pct: '12.50%', burn: false },
  { address: '1A1z...xY9m', balance: '89,420,000', pct: '8.94%', burn: false },
  { address: 'bc1q...7w3p', balance: '67,100,000', pct: '6.71%', burn: false },
  { address: '1Bvr...nNpJ', balance: '45,800,000', pct: '4.58%', burn: false },
  { address: '1Cou...pVr', balance: '38,200,000', pct: '3.82%', burn: true },
  { address: 'bc1q...f9k2', balance: '22,500,000', pct: '2.25%', burn: false },
  { address: '1J9u...RtY4', balance: '18,900,000', pct: '1.89%', burn: false },
  { address: '1Kf3...wQ7x', balance: '15,300,000', pct: '1.53%', burn: false },
]
...
export default function TradePageLayoutA() {
      ...
      <div className="px-1">
        {holders.map((holder, i) => (
          <div
            ...
            className="grid grid-cols-3 gap-0 px-2 py-px text-xs hover:bg-zinc-900 cursor-default"
          >
            <span className="text-zinc-600 font-mono flex items-center gap-1.5">
              {holder.address}
              {holder.burn && (
                <span className="rounded-sm bg-amber-500/15 px-1 py-px text-[10px] font-medium text-amber-400">
                  Burn
                </span>
              )}
            </span>
    ...
    <>
      ...
      <div className="px-1">
        {markets.map((mkt, i) => (
          <div
            key={`mkt-${i}`}
            className="grid grid-cols-4 gap-0 px-2 py-px text-xs hover:bg-zinc-900 cursor-default"
          >
            <span className="text-zinc-300 font-mono">{mkt.pair}</span>
            <span className="text-right text-zinc-400 font-mono">{mkt.price}</span>
            <span
              className={`text-right font-mono ${mkt.positive ? 'text-green-400' : 'text-red-400'}`}
            >
              {mkt.change}
            </span>
            <span className="text-right text-zinc-500 font-mono">{mkt.volume}</span>
          </div>
        ))}
      </div>
    </>
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-px bg-zinc-800">
        ...
        {/* ── Left Column: Order Book (desktop only) ─────────────────────
             lg:col-span-3, lg:order-1
        ──────────────────────────────────────────────────────────────── */}
        <div className="hidden lg:block lg:order-1 col-span-1 lg:col-span-3 bg-zinc-950">
        ...
        {/* ── Center Column: Chart + Tabbed Data ────────────────────────
             lg:col-span-6, lg:order-2
             On mobile: Chart + Trade form (order-1)
        ──────────────────────────────────────────────────────────────── */}
        <div className="order-1 lg:order-2 col-span-1 lg:col-span-6 bg-zinc-950 flex flex-col">
          ...
          {/* ── Mobile: Trade form directly below chart ──────────────── */}
          <div className="lg:hidden">
            {renderTradeForm()}
          </div>

          {/* ── Desktop: Tabbed Data Section below chart ─────────────── */}
          <div className="hidden lg:block border-t border-zinc-800">
            ...
            {/* Tab content */}
            {dataTab === 'trades' && renderTrades()}
            {dataTab === 'holders' && renderHolders()}
            {dataTab === 'markets' && renderMarkets()}
          </div>
        </div>

        {/* ── Right Column: Trade Form (desktop only) ────────────────────
             lg:col-span-3, lg:order-3
        ──────────────────────────────────────────────────────────────── */}
        <div className="hidden lg:block lg:order-3 col-span-1 lg:col-span-3 bg-zinc-950">
          <div className="border-b border-zinc-800 px-3 py-2">
            <h2 className="text-xs font-semibold uppercase tracking-wider text-zinc-400">
              Trade
            </h2>
        ...
        {/* ── Mobile Data Tab Bar ─────────────────────────────────────────
             Only visible below lg. Lets users toggle between book, trades, holders, markets.
        ──────────────────────────────────────────────────────────────── */}
        <div className="order-2 lg:hidden bg-zinc-950 flex border-b border-zinc-800">
        ...
        {/* ── Mobile Data Content ─────────────────────────────────────────
             Shows whichever mobile tab is selected.
        ──────────────────────────────────────────────────────────────── */}
        <div className={`order-3 lg:hidden col-span-1 bg-zinc-950 ${
          mobileDataTab === 'book' ? '' : 'hidden'
        }`}>
          {renderOrderBook()}
        </div>
