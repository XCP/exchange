...
const holders = [
  { address: '1Pe7...k8Fd', balance: '125,000,000', pct: '12.50%' },
  { address: '1A1z...xY9m', balance: '89,420,000', pct: '8.94%' },
  { address: 'bc1q...7w3p', balance: '67,100,000', pct: '6.71%' },
  { address: '1Bvr...nNpJ', balance: '45,800,000', pct: '4.58%' },
  { address: '1Cou...pVr', balance: '38,200,000', pct: '3.82%', note: 'Burn' },
  { address: 'bc1q...f9k2', balance: '22,500,000', pct: '2.25%' },
  { address: '1J9u...RtY4', balance: '18,900,000', pct: '1.89%' },
  { address: '1Kf3...wQ7x', balance: '15,300,000', pct: '1.53%' },
]

// -- Component ----------------------------------------------------------------

export default function TradePageLayoutE() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-px bg-zinc-800">
        ...
        <div className="order-2 lg:order-1 col-span-1 lg:col-span-3 bg-zinc-950">
          ...
          <div className="p-3 border-b border-zinc-800">
            ...
            <div className="flex items-baseline gap-2 mb-2">
              ...
              <span className="text-xs text-zinc-400">$0.0031</span>
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-1">
              <div className="flex items-center justify-between">
                <span className="text-xs text-zinc-600">24h High</span>
                <span className="text-xs text-zinc-300 font-mono">0.00000450</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-xs text-zinc-600">24h Low</span>
                <span className="text-xs text-zinc-300 font-mono">0.00000390</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-xs text-zinc-600">24h Vol</span>
                <span className="text-xs text-zinc-300 font-mono">3.42 XCP</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-xs text-zinc-600">Spread</span>
                <span className="text-xs text-zinc-300 font-mono">0.24%</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-3">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center justify-between text-xs">
                ...
                <span className="text-zinc-300 font-mono">0.00000010 <span className="text-zinc-600">(2.38%)</span></span>
              </div>
              <div className="flex items-center justify-between text-xs pt-1 border-t border-zinc-800/50">
                ...
                <span className="flex items-center gap-1.5 font-mono">
                  ...
                  <span className="text-zinc-300">0.00000420</span>
        ...
        <div className="order-1 lg:order-2 col-span-1 lg:col-span-9 bg-zinc-950 flex flex-col">
          ...
          <div className="border-b border-zinc-800">
            ...
            {/* Chart visualization */}
            <div className="relative px-4 py-4 max-sm:px-2" style={{ minHeight: '320px' }}>
              {/* Y-axis labels */}
          ...
          <div className="lg:hidden">
            {/* Mobile: Order Book */}
            <div className={mobileDataTab !== 'book' ? 'hidden' : ''}>
            ...
            {/* Mobile: Trades */}
            <div className={mobileDataTab !== 'trades' ? 'hidden' : ''}>
              <div className="h-[280px] overflow-y-auto">
                <div className="grid grid-cols-3 gap-0 px-3 py-1.5 text-xs text-zinc-600">
                  <span>Price (XCP)</span>
                  <span className="text-right">Amount</span>
            ...
            {/* Mobile: Orders */}
            <div className={mobileDataTab !== 'orders' ? 'hidden' : ''}>
              <div className="h-[280px] overflow-y-auto flex flex-col items-center justify-center">
                <svg className="h-8 w-8 text-zinc-700 mb-3" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                </svg>
                <p className="text-xs text-zinc-500 mb-2">Connect your wallet to view orders</p>
                <a href="#" className="text-xs text-green-400 hover:text-green-300 transition-colors">Connect Wallet</a>
              </div>
            </div>

            {/* Mobile: Holders */}
            <div className={mobileDataTab !== 'holders' ? 'hidden' : ''}>
              <div className="h-[280px] overflow-y-auto">
                <div className="grid grid-cols-3 gap-0 px-3 py-1.5 text-xs text-zinc-600">
                  <span>Address</span>
                ...
                <div className="px-1">
                  {holders.map((h, i) => (
                    <div
                      ...
                      className="grid grid-cols-3 gap-0 px-2 py-px text-xs hover:bg-zinc-900 cursor-default"
                    >
                      <span className="text-zinc-300 font-mono">{h.address}</span>
                      <span className="text-right text-zinc-400 font-mono">{h.balance}</span>
                      <span className="text-right text-zinc-500 font-mono">
                        {h.pct}
                        {h.note && <span className="text-zinc-600 ml-1">({h.note})</span>}
                      </span>
                    </div>
                  ))}
                </div>
            ...
            {/* Mobile: Markets */}
            <div className={mobileDataTab !== 'markets' ? 'hidden' : ''}>
              <div className="h-[280px] overflow-y-auto">
          ...
          {/* -- Desktop: Bottom Two Columns (Order Book + Tabbed Data) ------- */}
          <div className="hidden lg:grid grid-cols-5 gap-px bg-zinc-800 flex-1">

            {/* Left sub-column: Order Book (slimmer) */}
