...
export default function TradePageLayoutM() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-px bg-zinc-800">
        ...
        {/* == LEFT Column -- Form + Quick Stats (desktop: col 1-3) ============ */}
        ...
        {/* == CENTER Column -- Chart + Tabs (desktop: col 4-10) =============== */}
        <div className="order-1 lg:order-2 col-span-1 lg:col-span-7 bg-zinc-950 flex flex-col">
        ...
        {/* == RIGHT Column -- Order Book (desktop only, narrow) =============== */}
        <div
